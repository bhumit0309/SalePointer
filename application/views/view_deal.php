...
<title>SalePointer | Merchant &gt; View Deal</title>
...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="../tester/">Home</a><i class="fa fa-angle-right"></i><a href="../view_deal">Deals</a><i class="fa fa-angle-right"></i><?php echo "Deal name will be here!!"; ?></li>
            </ol>
                                        ...
                                        <div class="chute chute-center">
                                            <div class="row mb40">
                                                <div class="col-md-12">
                                                    <div class="col-md-3">
                                                        <div>
                                                            <img src="<?=base_url("salepointerimages/placeholder_deal.png") ?>" style="height: auto; width: 100%; max-height: 300px; max-width: 300px; min-height: 150px; min-width: 150px;" alt=""/>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-9">
                                                        <div class="spacing">
                                                            <h2>Deal Name will be here!!</h2>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4 spacing">
                                                        <h3>Reg: &dollar;<span style="font-face: bold; color: red;">30</span></h3>
                                                    </div>
                                                    <div class="col-md-5 spacing">
                                                        <h3>Current: &dollar;<span style="font-face: bold; color: blue;">30</span></h3>
                                                    </div>
                                                    <div class="col-md-9 spacing">
                                                        <h3>Save: &dollar;<span style="font-face: bold; color: green;">30</span></h3>
                                                    </div>
                                                    <div class="col-md-4 spacing">
                                                        <img src="<?=base_url("salepointerimages/placeholder_deal.png"); ?>" style="height: auto; width: 100%; max-height: 125px; max-width: 125px; min-height: 75px; min-width: 75px;" alt=""/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
