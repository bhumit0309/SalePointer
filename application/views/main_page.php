             ...
             <!--header start here-->
				<div class="header-main">
					<div class="logo-w3-agile">
                                                                                            <a href="index.html"><img src="http://localhost:8081\SalePointerImages\logo.png" class="img-responsive" style="height:100%;width: auto;"/></a>
							</div>
...
<!--COPY rights end here-->
  ...
  <!--//content-inner-->
			<!--/sidebar-menu-->
				<div class="sidebar-menu">
					<header class="logo1">
						...
						<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
									...
									<li><a href="faq.html"><i class="fa fa-exclamation-triangle" aria-hidden="true"></i><span>FAQ</span><div class="clearfix"></div></a></li>
				...
				<li id="menu-academico-avaliacoes" ><a href="icons.html">Add Deals</a></li>
				<li id="menu-academico-avaliacoes" ><a href="typography.html">Exclusive Deals</a></li>
				<li id="menu-academico-avaliacoes" ><a href="faq.html">Expired Deals</a></li>
                                                            </ul>
</li>
                                                                        
											
                                                                        <li> <a href="#"><i class="fa fa-sign-out" aria-hidden="true"></i><span>Logout</span><div class="clearfix"></div></a> </li>
                                                                        </ul>
                                                                    </div>
                                                        </div>
